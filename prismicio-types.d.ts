...
type HelloDocumentDataSlicesSlice = never;
...
interface HelloDocumentData {
   ...
   */
  slices: prismic.SliceZone<HelloDocumentDataSlicesSlice> /**
   * Meta Title field in *hello*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: hello.meta_title
   * - **Tab**: SEO & Metadata
  ...
  /**
   * Meta Description field in *hello*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A brief summary of the page
   * - **API ID Path**: hello.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Meta Image field in *hello*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hello.meta_image
   * - **Tab**: SEO & Metadata
 ...
 */
export type HelloDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<Simplify<HelloDocumentData>, "hello", Lang>;
...
export type AllDocumentTypes = HelloDocument | PageDocument;
